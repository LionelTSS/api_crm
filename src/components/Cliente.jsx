...
const Cliente = ({ cliente, handleEliminar }) => {
  ...
  const { nombre, empresa, email, numero, notas, id } = cliente;

  return (
    <tr className="border-b hover:bg-blue-100 transition ease-linear">
      ...
      <td className="p-3">
        ...
        <p>
          <span className="text-gray-800 uppercase font-bold">Num:</span>
          {numero}
        </p>
      </td>
